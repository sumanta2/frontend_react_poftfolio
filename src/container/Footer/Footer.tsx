...
const Footer = () => {
    ...
    const handleSubmit = () => {
        ...
        client.create(contact, { signal: abortController.signal }).then(() => {
            setLoading(false);
        ...
        <>
            ...
            <div className="app__footer-cards">
                ...
                <div className="app__footer-card">
                    ...
                    <a href="tel:+1 (123) 456-7890" className="p-text">tel:+1 (123) 456-7890</a>
                </div>
            </div>
            ...
            {!isFormSubmitted ? (
                ...
                <div className="app__footer-form app__flex">
                    ...
                    <button type="button" className="p-text" disabled={loading} onClick={handleSubmit}>{loading ? "Sending" : "Send Message"}</button>
                </div>
